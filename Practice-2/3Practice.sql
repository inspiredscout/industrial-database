...
-- 6. Удалить столбец «Описание» из таблицы «Структура объекта недвижимости».
ALTER TABLE real_estate_structure
DROP COLUMN description;

-- 7. Добавить новую таблицу «Структура объекта недвижимости» с нужными колонками и внешними ключами.
CREATE TABLE real_estate_structure (
    real_estate_object_id INT,
    room_type_id INT,
    area REAL CHECK (area > 0),
